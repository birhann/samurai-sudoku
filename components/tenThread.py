...
class TenThreadOptions():
    def __init__(self, GUI) -> None:
        ...
        self.isBottomLeftSudSolved2 = False
        self.isBottomRightSudSolved = False
        self.isBottomRightSudSolved2 = False
        self.isTopLeftSudSolved = False
        self.isTopLeftSudSolved2 = False
        self.isTopRightSudSolved = False
        self.isTopRight2SudSolved = False
    ...
    def sudokuSolvedLast(self):
        if self.isBottomLeftSudSolved == 2 and self.isBottomRightSudSolved == 2 and self.isTopLeftSudSolved == 2 and self.isTopRightSudSolved == 2:
            self.m.start()
            pass
    ...
    def createTLthread(self):
        ...
        self.tL2 = solveTopLeftWorker2()
        self.tL2.daemon = True
        self.tL2.sudoku = self.Sudoku
        self.tL2.setCell.connect(self.tLsetCell)
        self.tL2.finished.connect(self.tLthreadFinished)
    ...
    def createTRthread(self):
        ...
        self.tR2 = solveTopRightWorker2()
        self.tR2.daemon = True
        self.tR2.sudoku = self.Sudoku
        self.tR2.setCell.connect(self.tRsetCell)
        self.tR2.finished.connect(self.tRthreadFinished)
    ...
    def createBLthread(self):
        ...
        self.bL2 = solveBottomLeftWorker2()
        self.bL2.daemon = True
        self.bL2.sudoku = self.Sudoku
        self.bL2.setCell.connect(self.bLsetCell)
        self.bL2.finished.connect(self.bLthreadFinished)
    ...
    def createBRthread(self):
        ...
        self.bR2 = solveBottomRightWorker2()
        self.bR2.daemon = True
        self.bR2.sudoku = self.Sudoku
        self.bR2.setCell.connect(self.bRsetCell)
        self.bR2.finished.connect(self.bRthreadFinished)
...
class solveTopLeftWorker2(QThread):
    relevantSudokufinished = False
    setCell = pyqtSignal(int, int, int, object)
    sudoku = None
...
class solveBottomLeftWorker2(QThread):
    relevantSudokufinished = False
    setCell = pyqtSignal(int, int, int, object)
    sudoku = None
...
class solveBottomRightWorker2(QThread):
    relevantSudokufinished = False
    setCell = pyqtSignal(int, int, int, object)
    sudoku = None
...
class solveTopRightWorker2(QThread):
    relevantSudokufinished = False
    setCell = pyqtSignal(int, int, int, object)
    sudoku = None
